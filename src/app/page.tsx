                        ...
                        >
                          <div className="pt-2 pl-4">
                            ...
                            {customData.includePrivateCommits && (
                              <div className="mt-3 bg-[#c2703e]/[0.08] border border-[#c2703e]/20 rounded-xl p-4 shadow-inner">
                                <h4 className="text-[#c2703e] font-bold text-xs flex items-center gap-2 mb-2 tracking-wide uppercase">
                                  <Key className="w-3.5 h-3.5" /> Setup Required After Download
                                </h4>
                                <p className="text-xs text-[#d4956a]/80 mb-3 leading-relaxed">
                                  To access private commits, you must add a <code className="bg-[#141210]/60 px-1 py-0.5 rounded text-[#c2703e] font-mono">GH_PAT</code> secret with <code className="bg-[#141210]/60 px-1 py-0.5 rounded text-[#c2703e] font-mono">read:user</code> and <code className="bg-[#141210]/60 px-1 py-0.5 rounded text-[#c2703e] font-mono">repo</code> scopes to your repository's <strong>Actions Secrets</strong>.
                                </p>
                                <ol className="text-xs text-[#e8dcc8]/60 space-y-2 list-none">
                                  <li className="flex gap-2">
                                    <span className="bg-[#c2703e]/20 text-[#c2703e] font-bold w-4 h-4 rounded flex items-center justify-center flex-shrink-0 text-[9px]">1</span>
                                  ...
                                  <li className="flex gap-2">
                                    <span className="bg-[#c2703e]/20 text-[#c2703e] font-bold w-4 h-4 rounded flex items-center justify-center flex-shrink-0 text-[9px]">2</span>
                                  ...
                                  <li className="flex gap-2">
                                    <span className="bg-[#c2703e]/20 text-[#c2703e] font-bold w-4 h-4 rounded flex items-center justify-center flex-shrink-0 text-[9px]">3</span>
                                    <span>Generate and copy the token</span>
                                  </li>
                                  <li className="flex gap-2">
                                    <span className="bg-[#c2703e]/20 text-[#c2703e] font-bold w-4 h-4 rounded flex items-center justify-center flex-shrink-0 text-[9px]">4</span>
                                    <span>In your profile repo, go to <strong>Settings</strong> → <strong>Secrets and variables</strong> → <strong>Actions</strong></span>
                                  </li>
                                  <li className="flex gap-2">
                                    <span className="bg-[#c2703e]/20 text-[#c2703e] font-bold w-4 h-4 rounded flex items-center justify-center flex-shrink-0 text-[9px]">5</span>
